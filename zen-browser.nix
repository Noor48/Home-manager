{ stdenv, lib, fetchurl, autoPatchelfHook, makeWrapper, copyDesktopItems, makeDesktopItem, writeText, curl, jq
, dbus-glib
, gtk3
, xorg
, nss
...
let
  ...
  # This will be dynamically determined
  _pname = "zen-browser";

  # Use builtins.fetchurl for latest release
